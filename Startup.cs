...
namespace TurAgencijaRS2_WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICRUDService<TurAgencijaRS2_Model.Rezervacije, object, RezervacijeUpsertRequest, RezervacijeUpsertRequest>, BaseCRUDService<TurAgencijaRS2_Model.Rezervacije, object, Rezervacije, RezervacijeUpsertRequest, RezervacijeUpsertRequest>>();
